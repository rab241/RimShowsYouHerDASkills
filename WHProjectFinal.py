...
#As a single traveller and woman, I take being free and having social support as an essential. Generally leads to safety and being able to go around wherever I need on my own
#With my southern hospitality, I love the generosity and welcoming feel of people within a new country.
#For social support, generosity, and freedom to make life choices factors calculated into the ladder score. I want those to be a high weight of the ladder score.
...
#The best is the higher ladder score and smaller std dev of ladder score, if the larger ladder score has a larger std dev, then actually pick the one with next largest
